...
# obtained from scene images of the environment on which models have been be trained
# 
...
def classifier_mlp_softmax_3(n_classes=70):
    ...
    classifier.add(Dense(2048, input_shape = (3343,))) #set this to the sum of the number of optimal pixel locations from all 8 directions
